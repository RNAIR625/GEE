...
CREATE TABLE IF NOT EXISTS GEE_FIELD_CLASSES (
...
CREATE TABLE IF NOT EXISTS GEE_FIELDS (
...
CREATE TABLE IF NOT EXISTS  GEE_TABLES(
...
CREATE TABLE IF NOT EXISTS GEE_BASE_FUNCTIONS (
...
CREATE TABLE IF NOT EXISTS GEE_BASE_FUNCTIONS_PARAMS (
...
CREATE TABLE IF NOT EXISTS GEE_RULES_GROUPS (
...
CREATE TABLE IF NOT EXISTS GEE_RULES_DEF (
...
CREATE TABLE IF NOT EXISTS GEE_RULES_DEF_PARAMS (
    GRD_ID INTEGER PRIMARY KEY,
    GRG_ID INTEGER,
    GF_ID INTEGER,
    CREATE_DATE DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS GEE_FLOWS (
...
CREATE TABLE IF NOT EXISTS GEE_FLOW_VERSIONS (
...
CREATE TABLE IF NOT EXISTS GEE_FLOW_NODES (
...
CREATE TABLE IF NOT EXISTS GEE_FLOW_CONNECTIONS (
...
CREATE TABLE IF NOT EXISTS GEE_STATIONS (
...
CREATE TABLE IF NOT EXISTS GEE_STATION_RULE_GROUPS (
...
CREATE TABLE IF NOT EXISTS GEE_FLOW_VALIDATION_RULES (
...
CREATE TABLE IF NOT EXISTS GEE_FLOW_EXECUTION_LOG (
...
CREATE TABLE IF NOT EXISTS GEE_FLOW_EXECUTION_STEPS (
...
CREATE TABLE IF NOT EXISTS GEE_ACTIVE_CONNECTIONS (
